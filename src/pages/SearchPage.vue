<template>
  <div id="searchPage">
    <form action="/">
      ...
      <van-divider style="margin-top: -5px" content-position="center">选择标签</van-divider>
      <van-tree-select
      ...
      <van-cell-group inset>
        <van-field v-model="userDefinedTag" placeholder="请输入标签" style="padding-right: 5px">
          <template #button>
            <van-button size="small" round type="primary" @click="addUserDefinedTag">添 加</van-button>
          </template>
        </van-field>
      </van-cell-group>
    </form>
    <div style="margin: 32px">
      <van-button block type="primary" round @click="searchUser">搜 索</van-button>
    </div>
  </div>
</template>
